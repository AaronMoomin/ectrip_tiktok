...
Page({
    ...
    //点击预定
    handleReserve() {
        let {currentIndex, dateGlobal, dateGlobal2, adults, childrens} = this.data
        let type = ''
        switch (currentIndex) {
            case 1:
                type = '酒店';
    ...
    handleDate() {
        let {dateGlobal, dateGlobal2, yearT, yearN, today, tomorrow, weekT, weekN} = this.data
    ...
    bindDateChange(e) {
        let {yearT, dateGlobal, dateGlobal2, yearN, today, tomorrow, weekT, weekN} = this.data
        const weekday = ["星期日", "星期一", "星期二", "星期三", "星期四", "星期五", "星期六"];
    ...
    bindPickerChange: function (e) {
        let {index, index1, adults, childrens} = this.data
