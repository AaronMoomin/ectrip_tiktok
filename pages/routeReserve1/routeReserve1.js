...
Page({
    ...
    async getDailyPrice(day) {
        ...
        await request.myRequest(
            ...
            this.setData({
                price: res.data.data.dailyProductInfoList[0].settlementPrice
            })
            console.log(res);
        }).catch(err => {
            console.log(err);
    ...
    onLoad: function (options) {
        ...
        this.setData({
            ...
            price: options.product.dailyProductInfoList[0].settlementPrice,
            nowPrice: options.product.dailyProductInfoList[0].settlementPrice,
